...
Always apply `references/honest-evaluation.md` first. A polished deck cannot rescue a weak story. Say so directly.

## Data Files

- `data/presentation-decks.json`: deck types, slide sequences, required proof, red flags.
- `data/presentation-rubrics.json`: deck readiness scorecard.
- `data/accelerator-programs.json`: accelerator-specific fit.
- `data/accelerator-rubrics.json`: accelerator readiness.
- `data/judgment-policy.json`: non-flattering evaluation rule.
...
- Use `references/accelerators.md`.
