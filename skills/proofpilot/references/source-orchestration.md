...
For YC, Techstars, 500 Global, Antler, Entrepreneur First, Sequoia Arc, or non-web3 accelerator tasks, read `honest-evaluation.md` and `accelerators.md` before drafting or recommending.
